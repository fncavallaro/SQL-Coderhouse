...
CREATE TABLE `address` (
  ...
  `delivery_city` text,
  `delivery_zipcode` int DEFAULT NULL
...
INSERT INTO `auditoria_clientes` VALUES (1,2,'Nicolás','Cavallaro','2023-11-04','2023-11-04 15:23:55','root@localhost'),(2,3,'NICOLÁS','CAVALLARO','2023-11-04','2023-11-04 15:24:01','root@localhost'),(3,1,'NUEVONOMBRE','NUEVOAPELLIDO','2023-11-04','2023-11-04 15:36:37','root@localhost'),(4,2,'NICOLÁS','CAVALLARO','2023-11-04','2023-11-04 15:36:37','root@localhost'),(5,3,'NICOLÁS','CAVALLARO','2023-11-04','2023-11-04 15:36:37','root@localhost'),(6,1,'NUEVONOMBRE','NUEVOAPELLIDO','2023-11-04','2023-11-04 15:37:04','root@localhost'),(7,2,'NICOLÁS','CAVALLARO','2023-11-04','2023-11-04 15:37:04','root@localhost'),(8,3,'NICOLÁS','CAVALLARO','2023-11-04','2023-11-04 15:37:04','root@localhost');
...
CREATE TABLE `ingredient` (
  `ing_id` text,
  `ing_name` text,
  `ing_weight` int DEFAULT NULL,
  `ing_meas` text,
  `ing_price` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `inventory` VALUES (1,'ING001',30),(2,'ING002',50),(3,'ING003',70),(4,'ING004',70),(5,'ING005',70),(6,'ING006',70),(7,'ING007',70),(8,'ING008',70),(9,'ING009',70),(10,'ING010',70),(11,'ING011',70),(12,'ING012',70),(13,'ING013',70),(14,'ING014',70),(15,'ING015',70),(16,'ING016',70),(17,'ING017',70),(18,'ING018',70),(19,'ING019',70),(20,'ING020',70),(21,'ING021',70),(22,'ING022',70),(23,'ING023',70),(24,'ING024',70),(25,'ING025',70),(26,'ING026',70),(27,'ING027',70),(28,'ING028',70),(29,'ING029',70),(30,'ING030',70),(31,'ING031',70),(32,'ING032',70),(33,'ING033',70),(34,'ING034',70),(35,'ING035',70),(36,'ING036',70),(37,'ING037',70),(38,'ING038',70),(39,'ING039',70),(40,'ING040',70),(41,'ING041',70),(42,'ING042',70),(43,'ING043',70),(44,'ING044',70),(45,'ING045',70),(46,'ING046',70),(47,'ING047',70);
...
/*!50001 CREATE VIEW `pedidos` AS SELECT 
 ...
 1 AS `item_name`,
 1 AS `created_at`,
 1 AS `delivery_address1`,
 1 AS `delivery_address2`,
 1 AS `delivery_city`,
 1 AS `delivery_zipcode`,
 1 AS `delivery`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Table structure for table `registro_precio_productos`
--

DROP TABLE IF EXISTS `registro_precio_productos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `registro_precio_productos` (
  ...
  `usuario_modificacion` varchar(255) DEFAULT NULL,
  `cambio_precio` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `registro_precio_productos`
--

LOCK TABLES `registro_precio_productos` WRITE;
/*!40000 ALTER TABLE `registro_precio_productos` DISABLE KEYS */;
INSERT INTO `registro_precio_productos` VALUES (1,'it_001',12.00,30.00,'2023-11-04','17:13:40','root@localhost','Subió');
/*!40000 ALTER TABLE `registro_precio_productos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `registro_transacciones_inventario`
--

DROP TABLE IF EXISTS `registro_transacciones_inventario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `registro_transacciones_inventario`
--

LOCK TABLES `registro_transacciones_inventario` WRITE;
/*!40000 ALTER TABLE `registro_transacciones_inventario` DISABLE KEYS */;
INSERT INTO `registro_transacciones_inventario` VALUES (1,'ING001',30,30,'2023-11-04','2023-11-04 15:57:52','root@localhost'),(2,'ING002',50,50,'2023-11-04','2023-11-04 17:27:29','root@localhost');
/*!40000 ALTER TABLE `registro_transacciones_inventario` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `staff` VALUES ('st0001','Mindy','Sloan','Chef',17.25),('st0002','Luqman','Cantu','Head chef',21.5),('st0003','Seren','Lindsey','Chef',17.25),('st0004','Arran','Hodgson','Head chef',21.5),('st0005','Talha','Portillo','Chef',17.25),('st0006','Sana','Black','Head chef',21.5),('st0007','Zachery','Robins','Chef',17.25),('st0008','Faraz','Peck','Head chef',21.5),('st0009','Lilly-Rose','Vaughn','Delivery rider',14.5),('st0010','Desiree','Gardner','Delivery rider',14.5),('st0011','Ivan','English','Delivery rider',14.5),('st0012','Johnathon','Bradford','Delivery rider',14.5),('st0013','Matilda','Mccarty','Delivery rider',14.5),('st0014','Areeb','Vasquez','Delivery rider',14.5),('st0015','Amiyah','Lambert','Delivery rider',14.5),('st0016','Amrit','Greaves','Delivery rider',14.5);
/*!40000 ALTER TABLE `staff` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `vista_staff`
--

DROP TABLE IF EXISTS `vista_staff`;
/*!50001 DROP VIEW IF EXISTS `vista_staff`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_staff` AS SELECT 
 1 AS `date`,
 1 AS `first_name`,
 1 AS `last_name`,
 1 AS `hourly_rate`,
...
/*!50001 VIEW `clientes` AS select `customers`.`cust_lastname` AS `apellido`,`customers`.`cust_firstname` AS `nombre` from `customers` order by `customers`.`cust_lastname`,`customers`.`cust_firstname` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `delivery` AS select count(0) AS `count(*)` from `orders` where (`orders`.`delivery` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_stock` AS select `i`.`ing_name` AS `ing_name`,`inv`.`quantity` AS `quantity` from (`ingredient` `i` join `inventory` `inv` on((`i`.`ing_id` = `inv`.`item_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-11-18 17:50:24
